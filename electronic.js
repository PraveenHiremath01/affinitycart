...
class UI {
        ...
        <div class="product__footer">
          ...
          <div class="bottom">
            <div class="btn__group">
              <button class="btn addToCart" data-id= ${id} >Add-Cart</button>
    ...
    getButtons() {
        ...
        buttons.forEach(button => {
            ...
            if (inCart) {
                button.innerText = "Added on cart";
                button.disabled = true;
            }

            button.addEventListener("click", e => {
                e.preventDefault();
                e.target.innerHTML = "Added on cart";
...
class Products {
    async getProducts() {
        try {
            const result = await fetch("electronic.json");
